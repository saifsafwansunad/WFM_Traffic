 ...
 * Use the {@link ChartFragment3#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ChartFragment3 extends Fragment {
     ...
     * @return A new instance of fragment ChartFragment3.
     */
    // TODO: Rename and change types and number of parameters
    public static ChartFragment3 newInstance(String param1, String param2) {
        ChartFragment3 fragment = new ChartFragment3();
...
//        areaChart.title("Unaudited Apple Inc. Revenue by Operating Segments");
        ...
        seriesData.add(new CustomDataEntry("Q2 2014", 81.982, 10.941, 9.835, 4.047, 2.841));
        seriesData.add(new CustomDataEntry("Q3 2014", 84.574, 8.659, 6.230, 2.627, 2.242));
        seriesData.add(new CustomDataEntry("Q4 2014", 88.75, 10.35, 6.292, 3.595, 2.136));
        seriesData.add(new CustomDataEntry("Q1 2015", 89.6, 17.2, 16.1, 5.4, 5.2));
        seriesData.add(new CustomDataEntry("Q2 2015", 87.316, 12.204, 16.823, 3.457, 4.210));
        seriesData.add(new CustomDataEntry("Q3 2015", 80.209, 10.342, 13.23, 2.872, 2.959));
        seriesData.add(new CustomDataEntry("Q4 2015", 79.773, 10.577, 12.518, 3.929, 2.704));
        seriesData.add(new CustomDataEntry("Q1 2016", 72.3, 17.9, 18.4, 4.8, 5.4));
