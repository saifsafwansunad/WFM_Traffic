...
import com.example.wfm_traffic.chart.Tooltip
...
import com.example.wfm_traffic.chart.extensions.obtainStyledAttributes
import com.example.wfm_traffic.chart.extensions.toDataPoints
import com.example.wfm_traffic.chart.plugin.AxisGrid
import com.example.wfm_traffic.chart.plugin.AxisLabels
import com.example.wfm_traffic.chart.plugin.GridEffect
import com.example.wfm_traffic.chart.plugin.GridType
import com.example.wfm_traffic.chart.render.RendererConstants.Companion.NotInitialized
...
abstract class AxisChartView @JvmOverloads constructor(
    ...
    var animation: ChartAnimation<DataPoint> =
        com.example.wfm_traffic.chart.animation.DefaultAnimation()
