...
import com.example.wfm_traffic.chart.common.extension.*
...
fun HashMap<String, List<String?>>.toOralHygieneChart(): ArrayList<LineChartValue> {
    val arrayListOfMonthDate = Array(20) { index ->
        (index+1).toString()
    }
//    Log.d("chartremotedata", in)
    Log.d("chartremotedata", arrayListOfMonthDate.get(0))
